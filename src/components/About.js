...
function About() {
  ...
  const fuck=<a  className="a" href="/eggone">A collection of my interests and skills. </a>
  const headertext = {
    fontSize: '36pt',
    textAlign: 'center',
  };
...
my job experience allowed me to gain experience in testing and QA. As I am now independently learning I am focusing on mobile computing, game development, neural networks, RPA, and more.
      </blockquote><br/><br />
